...
function App() {
  ...
  const checkBanStatus = async (userId) => {
    try {
      const response = await axios.get('ec2-16-171-195-76.eu-north-1.compute.amazonaws.com:5000/api/user/status', {
        params: { userId }
      });
  ...
  const handlePostSuccess = (status) => {
    ...
    axios.get('ec2-16-171-195-76.eu-north-1.compute.amazonaws.com:5000/api/posts')
